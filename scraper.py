...
# New Google Gen AI SDK — uses v1 API, works with AI Studio keys
...
# ============================================================
#  GEMINI EXTRACTION using new google-genai SDK
# ============================================================
...
- Do NOT include: sector labels, regions, years, fund names, investment status
...
- If you find no company names at all, reply with just: NONE
...
async def scrape_portfolio(firm_name, api_key, status_widget=None):
    ...
    all_html = []
    update(f"Step 2/3 — Loading page and reading content...")
