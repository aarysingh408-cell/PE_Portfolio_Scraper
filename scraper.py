            ...
            json={
                ...
                "messages": [{
                    ...
                    "content": (
                        ...
                        f"- INCLUDE all types of investments: companies, real estate assets, infrastructure projects, parks, funds, digital businesses\n"                        
                        f"- INCLUDE non-English company names — Portuguese, Spanish, Hindi, or any other language\n"
                        f"- INCLUDE names that sound like places or properties if they appear as investment holdings\n"
                        ...
                        f"- Do NOT include website tools: Cloudflare, Cookiebot, Google, LinkedIn, Vimeo, YouTube, Facebook, Twitter\n"
...
DATABASE = {
    "KKR":                  {"url": "https://www.kkr.com/invest/portfolio", "pagination": "bot_blocked"},
    "Carlyle":              {"url": "https://www.carlyle.com/businesses/private-equity/portfolio",                                                                                                                                "pagination": "bot_blocked"},
    "Carlyle Group":        {"url": "https://www.carlyle.com/businesses/private-equity/portfolio",                                                                                                                                "pagination": "bot_blocked"},
    "Warburg Pincus":       {"url": "https://warburgpincus.com/investments/",                                                                                                                                                    "pagination": "bot_blocked"},
    "General Atlantic":     {"url": "https://www.generalatlantic.com/investments/?region=India",                                                                                                                                 "pagination": "bot_blocked"},
    "TPG":                  {"url": "https://www.tpg.com/portfolio?statuses=Active&geographies=Asia",                                                                                                                            "pagination": "bot_blocked"},
    "TPG Capital":          {"url": "https://www.tpg.com/portfolio?statuses=Active&geographies=Asia",                                                                                                                            "pagination": "bot_blocked"},
    "Advent International": {"url": "https://www.adventinternational.com/investments/?_sft_location_tax=india",                                                                                                                  "pagination": "bot_blocked"},
    "Advent":               {"url": "https://www.adventinternational.com/investments/?_sft_location_tax=india",                                                                                                                  "pagination": "bot_blocked"},
    "Apax":                 {"url": "https://www.apax.com/partnerships/?status=current",                                                                                                                                        "pagination": "bot_blocked"},
    "Apax Partners":        {"url": "https://www.apax.com/partnerships/?status=current",                                                                                                                                        "pagination": "bot_blocked"},
    "Bain Capital":         {"url": "https://www.baincapitalprivateequity.com/portfolio",                                                                                                                                        "pagination": "bot_blocked"},
    "CVC":                  {"url": "https://www.cvc.com/portfolio/our-portfolio/?strategy=all&country=India&industries=all&partner=undefined&cardName=null",                                                                     "pagination": "bot_blocked"},
    "CVC Capital":          {"url": "https://www.cvc.com/portfolio/our-portfolio/?strategy=all&country=India&industries=all&partner=undefined&cardName=null",                                                                     "pagination": "bot_blocked"},
    "CVC Capital Partners": {"url": "https://www.cvc.com/portfolio/our-portfolio/?strategy=all&country=India&industries=all&partner=undefined&cardName=null",                                                                     "pagination": "bot_blocked"},
    ...
    "Actis":                {"url": "https://www.act.is/about-us/portfolio/?_portfolio_status=current&_paged=", "pagination": "actis", "total_pages": 3},
}
...
async def scrape_portfolio(firm_name, api_key, status_widget=None):
    ...
    if db:
        # If site is known to block bots, return special signal
        if db.get('pagination') == 'bot_blocked':
            return ["BOT_BLOCKED:" + db['url']]
    ...
    async with async_playwright() as p:
        ...
        # Block heavy resources to prevent memory crashes on resource-limited servers
        await page.route("**/*.{png,jpg,jpeg,gif,webp,svg,woff,woff2,ttf,otf,mp4,mp3,avi,mov}", lambda route: route.abort())
        await page.route("**/{analytics,gtm,hotjar,intercom,drift,hubspot,segment,mixpanel}**", lambda route: route.abort())
