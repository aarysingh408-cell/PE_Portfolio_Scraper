...
# ============================================================
#  GEMINI — called directly via HTTP, no library needed
#  Uses v1 API which works with all AI Studio keys
# ============================================================
...
async def scrape_portfolio(firm_name, api_key, status_widget=None):
    ...
    update("Step 3/3 — Extracting company names with Gemini AI...")
